...
@rem ##########################################################################
@rem
@rem  cse-110-project-team-13 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CSE_110_PROJECT_TEAM_13_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CSE_110_PROJECT_TEAM_13_OPTS%  -classpath "%CLASSPATH%" App %*
...
:fail
rem Set variable CSE_110_PROJECT_TEAM_13_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CSE_110_PROJECT_TEAM_13_EXIT_CONSOLE%" exit 1
exit /b 1
